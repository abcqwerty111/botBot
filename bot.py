...
https://studfile.net/preview/3674409/page:13/'''
				bot.send_message(mid, answer)
...
На данный вопрос пока нет ответа
https://studopedia.ru/18_40603_obshchie-metodi-poiska-resheniy-v-prostranstve-sostoyaniy.html'''
				bot.send_message(mid, answer)
...
На данный вопрос пока нет ответа
https://studme.org/189760/tehnika/elementy_nechetkoy_logiki'''
				bot.send_message(mid, answer)
...
На данный вопрос пока нет ответа
https://studopedia.ru/18_40629_etapi-proektirovaniya-intellektualnih-sistem.html'''
				bot.send_message(mid, answer)
...
На данный вопрос пока нет ответа
https://studopedia.info/10-51333.html'''
				bot.send_message(mid, answer)
...
На данный вопрос пока нет ответа
https://studopedia.ru/18_40641_proektirovanie-bazi-znaniy.html'''
				bot.send_message(mid, answer)
...
На данный вопрос пока нет ответа
https://studfile.net/preview/897934/page:3/'''
				bot.send_message(mid, answer)
